...
- Implementation: `src/components/landing/`
  - `landing.tsx` — three-pillar architecture: header (with "Student login" soft-affordance routing to plain `/login`), hero, segmented pillar switch (Intel / Learn / Beyond the briefing), dark moat section, CTA, footer
