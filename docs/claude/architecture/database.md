...
| `migrations/indicators/001-indicators.sql` + `002-seed-catalogue.sql` | Indicators system: catalogue, append-only history with DB-enforced provenance, review queue. Apply via `pnpm tsx scripts/apply-indicators-migration.mjs` |
